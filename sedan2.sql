...
-- ----------------------------
BEGIN;
INSERT INTO `t_kelompok_penyusun` VALUES ('1', '15', '1', '2015-11-21 23:12:09'), ('10', '22', '1', '2015-12-02 04:19:34'), ('13', '19', '1', '2015-12-02 04:58:34'), ('14', '20', '1', '2015-12-02 05:36:50'), ('15', '21', '1', '2015-12-02 05:52:58'), ('16', '23', '1', '2015-12-02 07:08:19'), ('17', '24', '1', '2015-12-02 07:13:51'), ('19', '25', '1', '2015-12-03 11:48:33');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_konten` VALUES ('Dari', '1'), ('Kepada', '2'), ('Tanggal', '3'), ('ttdmemo1', '4'), ('nomormemo2', '5'), ('ttdmemo2', '6'), ('nomormemo3', '7'), ('ttdmemo3', '8'), ('Nomor', '9'), ('tgl_udg_pembukaan', '10'), ('tgl_udg_klarifikasi', '11'), ('tgl_udg_penandatanganan', '12'), ('perwakilan', '13');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_list_penyusun` VALUES ('1', '4', '1', '0'), ('2', '6', '1', '1'), ('4', '5', '1', '1'), ('19', '4', '10', '0'), ('20', '5', '10', '1'), ('23', '4', '13', '0'), ('24', '5', '13', '1'), ('25', '6', '13', '1'), ('26', '4', '14', '0'), ('27', '4', '15', '0'), ('28', '6', '15', '1'), ('29', '4', '16', '0'), ('30', '6', '16', '1'), ('31', '4', '17', '0'), ('34', '4', '19', '0'), ('35', '5', '19', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_pegawai` VALUES ('Mas Nopa', '1', '212121212121', '12121111111111111111', '4', '0'), ('Masnopa ika', '3', '33333333333333333', '111111111111111111', '5', '0'), ('Sukijan', '3', '1212121212', '111111111122222', '6', '0'), ('Prijaambodo Mardianto', '30', '2111111111111111113', null, '7', '0'), ('Riyani Indarti', '33', '', null, '8', '0');
COMMIT;
...
`pgd_status_selesai`  int(255) NULL DEFAULT 0 COMMENT '0 : belum selesai 1: selesai' ,
PRIMARY KEY (`pgd_id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `t_pengadaan` VALUES ('15', 'Pekerjaan Pembersihan dan Silent Kaca Luar Gedung GMB III', '0', 'Melakukan pemeliharaan gedung dengan melakukan pembersihan kaca luar gedung yang sudah kotor dan melakukan silent kaca yang telah bocor', '2015-12-03 03:36:09', '12345', '1', '45', '30', '2015-11-21', '0', '13812000.00', '15193200.02', '0.00', '0.00', '0.00', '0.00', '2015-12-04 03:35:40', '2015-12-15 03:35:44', '1', '0', '0'), ('19', 'Pengadaan barang yyy', '1', 'PEngadaan barang bagus yyy', '2015-12-02 07:26:15', '12345', '1', '30', '4', '2015-11-25', '0', '1200.00', '1320.00', '0.00', '0.00', '0.00', '0.00', null, null, '0', '0', '0'), ('20', 'dfshaasdasdas', '0', 're', '2015-12-03 13:12:17', '12345', '1', '3', '5', '2015-11-25', '0', '36300.00', '39930.00', '6150.00', '6765.00', '3150.00', '3465.00', '2015-12-03 13:12:17', '2015-12-03 13:12:17', '0', '2', '1'), ('21', 'Pengadaan keempat dsd', '0', 'asdff xxx', '2015-12-02 05:57:36', '54321', '1', '3', '45', '2015-12-02', '0', '32500.00', '35750.00', '24600.00', '27060.00', '0.00', '0.00', null, null, '0', '1', '0'), ('22', 'Pengadaan kelima', '0', '444', '2015-12-03 13:09:03', '54321', '1', '5', '5', '2015-12-02', '0', '19000.00', '20900.00', '14727.00', '16199.70', '12900.00', '14190.00', '2015-12-03 13:09:03', '2015-12-03 13:09:03', '0', '2', '1'), ('23', 'Pekerjaan pembersihan lantai xxx', '0', 'Membersihkan lantai semuanya', '2015-12-03 13:17:00', '54321', '1', '6', '6', '2015-12-02', '0', '170000.00', '187000.00', '157500.00', '173250.00', '150000.00', '165000.00', '2015-12-03 13:17:00', '2015-12-03 13:17:00', '1', '2', '0'), ('24', 'Pekerjaan pembersihan taman ccc', '0', 'Membersihkan taman depan gedung', '2015-12-02 07:21:41', '12345', '1', '4', '4', '2015-12-02', '0', '250000.00', '275000.00', '250000.00', '275000.00', '0.00', '0.00', null, null, '1', '1', '0'), ('25', 'Pengadaan komputer xx', '0', 'Komputer Baru', '2015-12-03 11:48:32', '12345', '1', '3', '10', '2015-12-03', '0', '100000.00', '110000.00', '0.00', '0.00', '0.00', '0.00', '2015-12-03 08:00:00', '2015-12-04 16:00:00', '0', '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_surat` VALUES ('1', 'Memorandum'), ('2', 'HPS'), ('3', 'Daftar Harga'), ('4', 'Spesifikasi Teknis'), ('5', 'LDP'), ('6', 'Undangan'), ('7', 'Daftar Hadir');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tr_detail_konten` VALUES ('Kabag Perlengkapan ', '17', '1', '3'), ('Kabag TU Pimpinan ', '18', '2', '3'), ('2015-12-03', '19', '3', '3'), ('Masnopa ika', '20', '4', '3'), ('1066/PPK.5/VI/2015', '21', '5', '3'), ('Mas Nopa', '22', '6', '3'), ('114.7/PPK.5/VI/2015', '23', '7', '3'), ('Riyani Indarti', '24', '8', '3'), ('1066/PPK.5/VI/2015', '25', '9', '5'), ('b.114.8/ppk.5/vI/20015', '26', '9', '8'), ('2015-12-03 08:00', '27', '10', '8'), ('2015-12-03 16:00', '28', '11', '8'), ('2015-12-04', '29', '12', '8'), ('b.114.8/ppk.5/vI/20015', '30', '9', '9'), ('2015-12-03', '31', '3', '9'), ('Sugiri', '32', '13', '9'), ('Kabag Perlengkapan ', '33', '1', '10'), ('Kabag Perlengkapan ', '34', '2', '10'), ('2015-12-03', '35', '3', '10'), ('Sukijan', '36', '4', '10'), ('121/MEMO/VII', '37', '5', '10'), ('Masnopa ika', '38', '6', '10'), ('122/MEMO/VII', '39', '7', '10'), ('Riyani Indarti', '40', '8', '10'), ('Kabag TU Pimpinan ', '41', '1', '11'), ('Kabag Perlengkapan ', '42', '2', '11'), ('2015-12-03', '43', '3', '11'), ('Mas Nopa', '44', '4', '11'), ('121/MEMO/VII', '45', '5', '11'), ('Masnopa ika', '46', '6', '11'), ('122/MEMO/VII', '47', '7', '11'), ('Riyani Indarti', '48', '8', '11'), ('535353MAM', '49', '9', '13'), ('FGDG', '50', '9', '15'), ('2015-12-03 08:00', '51', '10', '15'), ('2015-12-03 03:00', '52', '11', '15'), ('2015-12-11', '53', '12', '15'), ('KGKUGHK', '54', '9', '16'), ('2015-12-03', '55', '3', '16'), ('Sugiri', '56', '13', '16');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tr_detail_surat` VALUES ('3', '1', '2015-12-03 04:33:39', '3', '15'), ('4', '2', '2015-12-03 04:34:08', '3', '15'), ('5', '3', '2015-12-03 04:35:18', '3', '15'), ('6', '4', '2015-12-03 09:49:32', '3', '15'), ('7', '5', '2015-12-03 09:49:59', '3', '15'), ('8', '6', '2015-12-03 10:48:57', '3', '15'), ('9', '7', '2015-12-03 10:55:28', '3', '15'), ('10', '1', '2015-12-03 11:59:45', '1', '25'), ('11', '1', '2015-12-03 12:00:58', '1', '25'), ('12', '2', '2015-12-03 12:04:08', '1', '25'), ('13', '3', '2015-12-03 12:07:11', '1', '25'), ('14', '4', '2015-12-03 12:07:46', '1', '25'), ('15', '6', '2015-12-03 12:11:07', '1', '25'), ('16', '7', '2015-12-03 12:15:07', '1', '25');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tr_pgd_suratizin` VALUES ('8', '22', '1', '1'), ('10', '19', '1', '0'), ('11', '20', '1', '1'), ('12', '21', '1', '1'), ('13', '23', '1', '1'), ('14', '24', '1', '1'), ('16', '25', '1', '0');
COMMIT;
...
-- ----------------------------
ALTER TABLE `t_detail_pengadaan` AUTO_INCREMENT=54;
...
-- ----------------------------
ALTER TABLE `t_kelompok_penyusun` AUTO_INCREMENT=20;

-- ----------------------------
-- Auto increment value for t_list_penyusun
-- ----------------------------
ALTER TABLE `t_list_penyusun` AUTO_INCREMENT=36;

-- ----------------------------
-- Auto increment value for t_pegawai
-- ----------------------------
ALTER TABLE `t_pegawai` AUTO_INCREMENT=9;

-- ----------------------------
-- Auto increment value for t_pengadaan
-- ----------------------------
ALTER TABLE `t_pengadaan` AUTO_INCREMENT=26;
...
-- ----------------------------
ALTER TABLE `tr_detail_konten` AUTO_INCREMENT=57;

-- ----------------------------
-- Auto increment value for tr_detail_surat
-- ----------------------------
ALTER TABLE `tr_detail_surat` AUTO_INCREMENT=17;

-- ----------------------------
-- Auto increment value for tr_pgd_suratizin
-- ----------------------------
ALTER TABLE `tr_pgd_suratizin` AUTO_INCREMENT=17;
