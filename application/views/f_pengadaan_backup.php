...
$(document).ready(function() {
   ...
   // $('#btnSubmitPengadaan').hide();
    ...
    $("#chkBoxPajak").change(function() {
        if(this.checked) {
            var ppnInput = document.getElementById("pgd_jml_ssdh_ppn_hps");
            ppnInput.type="hidden";
            document.getElementById('lbl_pgd_jml_ssdh_ppn_hps').innerHTML = '';
        }else{
            var ppnInput = document.getElementById("pgd_jml_ssdh_ppn_hps");
            ppnInput.type="text";
            document.getElementById('lbl_pgd_jml_ssdh_ppn_hps').innerHTML = 'Total(ppn 10%) : &nbsp';
        }
    });
    ...
    $("#addnewpekerjaan").on("click", function(){
        ...
        //status dengan pajak
        var statusPajak = document.getElementById("dtp_hargasatuan_hps");
