...
//Header
		...
		$pdf->Cell(0,5,'BERITA ACARA PEMBAYARAN PEKERJAAN',0,2,'C');
		...
		$pdf->MultiCell(0,5,'Pada hari'.$nomorBAH->dknt_isi.', Evaluasi Administrasi, Evaluasi Teknis dan Penawaran Harga calon  Penyedia Barang/Jasa '.$d->pgd_perihal.' sebagaimana terlampir, maka Pejabat Pengadaan Barang/Jasa Satker Biro Umum menetapkan penyedia '.$d->pgd_perihal.' sebagai berikut :',0,'J');
		$pdf->Ln(5);
