<?php   $role = $this->session->userdata('id_role'); 
    ...
    switch ($statusPengadaan) {
        case "0":
            $Judul = "Pengadaan Konsultan(Setelah HPS)";
            $SubJudul = "Pengadaan Konsultan(Setelah HPS)";
            $linkAjax =  site_url('Pengadaan/ajaxProcessKonsultan/0');
            break;
        case "1":
            $Judul = "Pengadaan Konsultan(Setelah Penawaran)";
            $SubJudul = "Pengadaan Konsultan(Setelah Penawaran)";
            $linkAjax =  site_url('Pengadaan/ajaxProcessKonsultan/1');
            break;
        case "2":
            $Judul = "Pengadaan Konsultan(Setelah Negoisasi)";
            $SubJudul = "Pengadaan Konsultan(Setelah Negoisasi)";
            $linkAjax =  site_url('Pengadaan/ajaxProcessKonsultan/2');
            break;
        case "3":
            $Judul = "Pengadaan Konsultan(Setelah Pengumuman)";
            $SubJudul = "Pengadaan Konsultan(Setelah Pengumuman)";
            $linkAjax =  site_url('Pengadaan/ajaxProcessKonsultan/3');
            break;
        case "4":
            $Judul = "Pengadaan Konsultan(Setelah SPMK)";
            $SubJudul = "Pengadaan Konsultan(Setelah SPMK)";
            $linkAjax =  site_url('Pengadaan/ajaxProcessKonsultan/4');
            break;
        case "5":
            $Judul = "Pengadaan Konsultan(Telah Selesai)";
            $SubJudul = "Pengadaan Konsultan(Telah Selesai)";
            $linkAjax =  site_url('Pengadaan/ajaxProcessKonsultan/5');
            break;
        default:
            $Judul = "Pengadaan Konsultan";
            $SubJudul = "Pengadaan Konsultan";
            $linkAjax =  site_url('Pengadaan/ajaxProcessKonsultan/-1'); 
...
<div class="container-fluid">
    <div class="row-fluid">
        <h1>
            ...
            <a class="btn btn-success" data-toggle='tooltip' data-placement='top' title='Tambah Pengadaan Konsultan' href="<?php echo base_url()."Pengadaan/";?>add_Pengadaan/konsultan"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></a>
        </h1>
        <hr>
		...
		"drawCallback": function( settings ) {
			...
			makeTooltip();
                ...
                "createdRow": function ( row, data, index ) {
                    ...
                    $(row).click(function(){window.location.href = '<?php echo site_url('Pengadaan/detail_pengadaan_konsultan').'/'; ?>'+data.pgd_id;});
